 ...
 *
 * Date:           Fri May 27 12:54:27 2016
 * Model version:  1.1099
 * Matlab version: 8.0 (R2011a) 09-Mar-2011
 ****************************************************************************/
...
typedef qbot2_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * qbot2(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(qbot2_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: qbot2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
